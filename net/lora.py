...
class LoRA_ViT(nn.Module):
    ...
    def __init__(self, vit_model: ViT, r: int, lora_layer=None):
    ...
    def save_lora_parameters(self, filename: str) -> None:
        ...
        fc_tensors = {f"fc_weight": self.lora_vit.classifier[0].weight, 'fc_bias': self.lora_vit.classifier[0].bias}
    ...
    def load_lora_parameters(self, filename: str) -> None:
        ...
        with safe_open(filename, framework="pt") as f:
            ...
            try:
                ...
                self.lora_vit.classifier[0].weight = Parameter(f.get_tensor("fc_weight"))
                self.lora_vit.classifier[0].bias = Parameter(f.get_tensor("fc_bias"))
            except ValueError:
                print("this fc weight is not for this model")
    ...
    def forward(self, x1, x2, x3):
        return self.lora_vit(x1, x2, x3)

    def encode_image(self, x):
        return self.lora_vit.encode_image(x)
